...
const successTotal = document.querySelector('.success__total');
...
const catalog = new Catalog(catalogContainer, (item) => new Card(item, (product) => basket.addItem(product)), (item) => events.emit('card:select', item));
